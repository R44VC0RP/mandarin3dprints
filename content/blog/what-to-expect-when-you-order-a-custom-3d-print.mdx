...
Prepare a short specification with the model revision, dimensions, material, quantity, critical tolerances, and deadline. Use it to compare quotes on the same basis.
