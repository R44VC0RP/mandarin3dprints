...
PETG living hinges can be useful for small boxes, covers, and low-cycle prototypes. Validate the geometry with repeated flexing rather than assuming a particular service life.
...
Print a small hinge sample using the intended material and orientation. Record how it behaves over repeated cycles, including cracks, tearing, and loss of shape. If the required life is beyond what the sample demonstrates, consider a separate mechanical hinge instead.
