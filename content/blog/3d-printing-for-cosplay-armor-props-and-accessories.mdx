...
PETG can offer useful toughness and more heat resistance than ordinary PLA, but it can still deform in a hot car. Compare the actual grade and conditions in the [PETG guide](/blog/petg-explained-when-and-why-to-use-this-versatile-material). Printed cosplay armor and helmets are costumes, not protective equipment.
...
For wearable costume pieces, balance handling durability with weight. Infill around 10-15% and 3-4 perimeters can be starting points, not impact ratings. Print a sample and check attachment points and sharp edges. The [wall-thickness guide](/blog/wall-thickness-guide-minimum-and-optimal-measurements) explains how to inspect the actual structure.
