...
- Widely accepted by print services; confirm the recipient's requirements
...
- Can store polygon faces as well as texture and normal information
- Precision depends on the exported geometry, not an automatic advantage over STL
...
- Defined model structure and validation rules; geometry still needs printability checks
...
| Requires geometry review | Yes | Yes | Yes |
...
- You want units and supported project information packaged with the geometry
...
**When in doubt, ask the recipient.** 3MF can preserve useful information, but a slicer-specific project may not transfer every setting to another application. Follow the [export and mesh-repair checklist](/blog/how-to-prepare-your-3d-model-for-printing) regardless of format.
...
Keep the editable source model as well as the exported print file. The [handoff checklist](/blog/preparing-your-3d-model-for-printing) covers dimensions, material requirements, quantity, and revision approval so the recipient can check the import rather than guess.
