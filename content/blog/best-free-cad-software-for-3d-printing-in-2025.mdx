...
Open the exported file in a slicer and verify scale, wall thickness, and unsupported features. Keep the original CAD file so you can make precise changes after a test print.
